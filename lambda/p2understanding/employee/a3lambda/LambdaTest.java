package com.atguigu.java8.lambda.p2understanding.employee.a3lambda;
...
public class LambdaTest {
    ...
    @Test
    public void test1() {
        List<Employee> list = filterEmployees(employees, employee -> employee.getAge() >= 35);
